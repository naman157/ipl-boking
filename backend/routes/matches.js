  ...
  try {
    ...
    const matches = [
      ...
      },
      {
        ...
        ticketCategories: [
          { name: 'Platinum Pavilion', price: 5500, totalSeats: 1800, availableSeats: 1500, color: '#E5C100' },
          { name: 'Gold Stand', price: 2800, totalSeats: 7000, availableSeats: 6500, color: '#FFD700' },
          { name: 'Silver Stand', price: 1600, totalSeats: 14000, availableSeats: 12000, color: '#C0C0C0' },
          { name: 'General', price: 650, totalSeats: 17200, availableSeats: 15000, color: '#CD7F32' }
        ]
      },
      {
        matchNumber: 3,
        ...
        ticketCategories: [
          { name: 'Platinum Pavilion', price: 4800, totalSeats: 2000, availableSeats: 1700, color: '#E5C100' },
          { name: 'Gold Stand', price: 2400, totalSeats: 8000, availableSeats: 7000, color: '#FFD700' },
          { name: 'Silver Stand', price: 1400, totalSeats: 15000, availableSeats: 13000, color: '#C0C0C0' },
          { name: 'General', price: 550, totalSeats: 16820, availableSeats: 14000, color: '#CD7F32' }
        ]
      },
      {
        matchNumber: 4,
      ...
      },
      {
        ...
        ticketCategories: [
          { name: 'Platinum Pavilion', price: 4000, totalSeats: 1500, availableSeats: 1200, color: '#E5C100' },
          { name: 'Gold Stand', price: 2200, totalSeats: 6000, availableSeats: 5500, color: '#FFD700' },
          { name: 'Silver Stand', price: 1300, totalSeats: 11000, availableSeats: 9500, color: '#C0C0C0' },
          { name: 'General', price: 500, totalSeats: 11500, availableSeats: 10000, color: '#CD7F32' }
        ]
      },
      ...
      },
      {
        ...
        ticketCategories: [
          { name: 'Platinum Pavilion', price: 5000, totalSeats: 3000, availableSeats: 2700, color: '#E5C100' },
          { name: 'Gold Stand', price: 2500, totalSeats: 12000, availableSeats: 11000, color: '#FFD700' },
          { name: 'Silver Stand', price: 1500, totalSeats: 25000, availableSeats: 22000, color: '#C0C0C0' },
          { name: 'General', price: 600, totalSeats: 28000, availableSeats: 25000, color: '#CD7F32' }
        ]
      },
      {
        matchNumber: 8,
      ...
      },
      {
        ...
        ticketCategories: [
          { name: 'Platinum Pavilion', price: 4200, totalSeats: 2000, availableSeats: 1800, color: '#E5C100' },
          { name: 'Gold Stand', price: 2100, totalSeats: 8000, availableSeats: 7200, color: '#FFD700' },
          { name: 'Silver Stand', price: 1250, totalSeats: 16000, availableSeats: 14000, color: '#C0C0C0' },
          { name: 'General', price: 500, totalSeats: 24000, availableSeats: 21000, color: '#CD7F32' }
        ]
      },
      ...
      // PLAYOFFS
      {
        ...
        matchType: 'qualifier',
        ticketCategories: [
          { name: 'Platinum Pavilion', price: 10000, totalSeats: 5000, availableSeats: 4000, color: '#E5C100' },
          { name: 'Gold Stand', price: 5000, totalSeats: 20000, availableSeats: 17000, color: '#FFD700' },
          { name: 'Silver Stand', price: 3000, totalSeats: 50000, availableSeats: 43000, color: '#C0C0C0' },
      ...
      },
      {
        ...
        ticketCategories: [
          { name: 'Platinum Pavilion', price: 8000, totalSeats: 3000, availableSeats: 2500, color: '#E5C100' },
          { name: 'Gold Stand', price: 4000, totalSeats: 12000, availableSeats: 10000, color: '#FFD700' },
          { name: 'Silver Stand', price: 2500, totalSeats: 25000, availableSeats: 21000, color: '#C0C0C0' },
          { name: 'General', price: 1000, totalSeats: 28000, availableSeats: 24000, color: '#CD7F32' }
        ]
      },
      {
        matchNumber: 68,
        ...
        matchType: 'qualifier',
        ticketCategories: [
          { name: 'Platinum Pavilion', price: 12000, totalSeats: 1500, availableSeats: 1200, color: '#E5C100' },
          { name: 'Gold Stand', price: 6000, totalSeats: 6000, availableSeats: 5000, color: '#FFD700' },
          { name: 'Silver Stand', price: 3500, totalSeats: 12000, availableSeats: 10000, color: '#C0C0C0' },
          { name: 'General', price: 1500, totalSeats: 13608, availableSeats: 11000, color: '#CD7F32' }
        ]
      },
      {
        matchNumber: 70,
        ...
        matchType: 'final',
        ticketCategories: [
          { name: 'Platinum Pavilion', price: 20000, totalSeats: 5000, availableSeats: 4000, color: '#E5C100' },
          { name: 'Gold Stand', price: 10000, totalSeats: 20000, availableSeats: 16000, color: '#FFD700' },
          { name: 'Silver Stand', price: 6000, totalSeats: 50000, availableSeats: 42000, color: '#C0C0C0' },
          { name: 'General', price: 2500, totalSeats: 57000, availableSeats: 50000, color: '#CD7F32' }
        ]
      }
    ];
